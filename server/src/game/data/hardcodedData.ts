...
export const WAVE_TEMPLATES: WaveTemplate[] = [
  // ── Wave 1: 성난 너구리 가족 ──
  {
    ...
    choicesByBackground: {
      '전직 경비원': [
        ...
        { text: '패딩으로 방어 자세를 취한다', category: 'defensive', baseDC: 10 },
      ],
      '요리사': [
        { text: '남은 음식으로 다른 곳으로 유인한다', category: 'creative', baseDC: 9 },
        { text: '프라이팬을 꺼내 위협한다', category: 'physical', baseDC: 11 },
      ],
      '개발자': [
        { text: '스마트폰 플래시로 눈부시게 한다', category: 'technical', baseDC: 10 },
        { text: '노트북을 방패 삼아 방어한다', category: 'defensive', baseDC: 12 },
      ],
      '영업사원': [
        { text: '차분한 목소리로 너구리를 진정시킨다', category: 'social', baseDC: 9 },
        { text: '명함을 던져 주의를 돌린다', category: 'creative', baseDC: 11 },
      ],
    },
    defaultChoices: [
      { text: '소리를 질러 쫓아본다', category: 'physical', baseDC: 10 },
      { text: '천천히 뒷걸음질 친다', category: 'defensive', baseDC: 9 },
    ],
  },
  ...
  // ── Wave 2: 이상한 자판기 ──
  {
    ...
    choicesByBackground: {
      '전직 경비원': [
        { text: '배트로 캔을 쳐낸다', category: 'physical', baseDC: 9 },
        { text: '옆 건물 뒤로 숨어 접근한다', category: 'defensive', baseDC: 11 },
      ],
      '요리사': [
        { text: '동전을 넣어 달래본다', category: 'creative', baseDC: 10 },
        { text: '캔을 잡아서 되던진다', category: 'physical', baseDC: 13 },
      ],
      '개발자': [
        { text: '전원 코드를 찾아 뽑는다', category: 'technical', baseDC: 9 },
        { text: '노트북으로 자판기를 해킹한다', category: 'technical', baseDC: 12 },
      ],
      '영업사원': [
        { text: '"사실 저도 힘든 하루였어요" 공감한다', category: 'social', baseDC: 10 },
        { text: '자판기에게 비즈니스 제안을 한다', category: 'social', baseDC: 13 },
      ],
    },
    defaultChoices: [
      { text: '물건을 던져 주의를 끈다', category: 'creative', baseDC: 11 },
  ...
  // ── Wave 3: 그림자 고양이 떼 ──
  {
    ...
    choicesByBackground: {
      '전직 경비원': [
        { text: '열쇠고리 손전등을 켠다', category: 'defensive', baseDC: 11 },
        { text: '배트를 빙글빙글 돌리며 공간을 확보한다', category: 'physical', baseDC: 12 },
      ],
      '요리사': [
        { text: '참치캔을 열어 한쪽으로 던진다', category: 'creative', baseDC: 10 },
        { text: '칼을 빛에 반사시켜 고양이를 현혹한다', category: 'creative', baseDC: 13 },
      ],
      '개발자': [
        { text: '보조배터리로 가로등을 임시 충전한다', category: 'technical', baseDC: 12 },
        { text: '폰으로 고양이 울음소리를 재생한다', category: 'technical', baseDC: 14 },
      ],
      '영업사원': [
        { text: '"우리는 적이 아니에요" 협상한다', category: 'social', baseDC: 12 },
        { text: '고양이 대장에게 다가가 신뢰를 쌓는다', category: 'social', baseDC: 14 },
      ],
    },
    defaultChoices: [
      { text: '큰 소리를 내서 위협한다', category: 'physical', baseDC: 12 },
      { text: '가만히 서서 적대감이 없음을 보인다', category: 'defensive', baseDC: 11 },
    ],
  },
  ...
  // ── Wave 4: 폭주 청소로봇 ──
  {
    ...
    choicesByBackground: {
      '전직 경비원': [
        { text: '배트로 브러시를 멈추려 한다', category: 'physical', baseDC: 12 },
        { text: '패딩으로 감싼 쓰레기통을 방패로 쓴다', category: 'defensive', baseDC: 13 },
        { text: '뒤에서 킥으로 전원부를 공격한다', category: 'physical', baseDC: 15 },
      ],
      '요리사': [
        { text: '기름을 바닥에 뿌려 미끄러뜨린다', category: 'creative', baseDC: 11 },
        { text: '프라이팬으로 센서를 가린다', category: 'creative', baseDC: 14 },
      ],
      '개발자': [
        { text: '제어 패널을 찾아 긴급 정지 코드를 입력한다', category: 'technical', baseDC: 11 },
        { text: '와이파이로 로봇 펌웨어에 접근한다', category: 'technical', baseDC: 14 },
      ],
      '영업사원': [
        { text: '"당신의 노고에 감사합니다" 감성 어필한다', category: 'social', baseDC: 13 },
        { text: '로봇에게 유급휴가를 제안한다', category: 'social', baseDC: 15 },
      ],
    },
    defaultChoices: [
      { text: '벽 쪽으로 유인해서 부딪치게 한다', category: 'creative', baseDC: 13 },
      { text: '좁은 틈으로 숨는다', category: 'defensive', baseDC: 12 },
    ],
  },
  ...
  // ── Wave 5 (미드보스): 야시장의 주인 ──
  {
    ...
    choicesByBackground: {
      '전직 경비원': [
        { text: '정면으로 돌진해 탈을 벗긴다', category: 'physical', baseDC: 14 },
        { text: '포장마차를 방패 삼아 접근한다', category: 'defensive', baseDC: 15 },
        { text: '동료를 지키며 방어진을 편다', category: 'defensive', baseDC: 13 },
      ],
      '요리사': [
        { text: '노점 화덕의 불을 이용해 공격한다', category: 'creative', baseDC: 13 },
        { text: '최고의 야식을 만들어 제안한다', category: 'creative', baseDC: 16 },
        { text: '포장마차 기구로 트랩을 만든다', category: 'technical', baseDC: 15 },
      ],
      '개발자': [
        { text: '야시장 전력 시스템을 해킹한다', category: 'technical', baseDC: 13 },
        { text: '보조배터리로 과부하를 일으킨다', category: 'technical', baseDC: 16 },
      ],
      '영업사원': [
        { text: '"이 야시장의 진짜 가치를 아시나요?" 설득한다', category: 'social', baseDC: 14 },
        { text: '동료들의 사기를 끌어올리는 연설을 한다', category: 'social', baseDC: 12 },
        { text: '계약서를 꺼내 협상을 시도한다', category: 'social', baseDC: 18 },
      ],
    },
    defaultChoices: [
      { text: '주변의 물건을 던져 공격한다', category: 'physical', baseDC: 14 },
      { text: '동료 뒤에서 지원한다', category: 'defensive', baseDC: 13 },
    ],
  },
];
